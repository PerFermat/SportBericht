...
public final class DatabaseSchemaInitializer {
	...
	private static List<String> createStatements() {
		return List.of(
				...
				"CREATE TABLE IF NOT EXISTS freigegeben (vereinnr VARCHAR(20) NOT NULL, ergebnisLink VARCHAR(255) NOT NULL, timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, heim VARCHAR(100), gast VARCHAR(100), datum DATE, ergebnis VARCHAR(20), name VARCHAR(100), liga VARCHAR(100), PRIMARY KEY (vereinnr, ergebnisLink)");
